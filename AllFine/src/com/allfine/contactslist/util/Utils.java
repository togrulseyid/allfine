...
package com.allfine.contactslist.util;

import com.allfine.activities.ContactsSynchronizationActivity;
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (Utils.hasHoneycomb()) {
                ...
                vmPolicyBuilder
                        .setClassInstanceLimit(ContactsSynchronizationActivity.class, 1);
            }
